(function () {
  ...
  /* =========================================
     HOME INSERTS: cria um "slot" estável após o slider
     e insere Banners + Carrossel sempre em ordem
  ========================================= */
  function getHomeAnchor(){
    ...
    // insere logo após o slider quando possível (ideal)
  ...
  function injectBrandsCarousel(){
    ...
    // Dobra pra dar "faixa" visual (sem JS de animação ainda)
  ...
  /* =========================================
     CSS "blindado" do carrossel (evita empilhar/esticar)
     - marcas lado a lado
     - largura fixa 180px
  ========================================= */
  function injectCarouselStyle(){
    ...
    st.textContent = [
      ...
      ".v1-brand{display:inline-flex !important;flex:0 0 180px !important;width:180px !important;max-width:180px !important;align-items:center !important;justify-content:center !important;padding:10px 14px !important;border:1px solid rgba(0,0,0,0.10);background:rgba(255,255,255,0.55);-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);text-decoration:none !important;}",
